...
class roomBuidler:
    ...
    def __init__(self):
        ...
        self.angularResolution = np.round(eq.angularResolution(np.random.randint(1,3),self.wavelengths[0]),1)
        ...
        diff.create_circles_image("diffimg/mysterywavelength.png",eq.diffractionGrating(wavelen),eq.Intensity(wavelen),"Mystery Color", 10)
